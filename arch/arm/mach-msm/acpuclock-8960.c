...
#define MAX_VDD_SC    1350000 /* custom voltage */ 
#define MIN_VDD_SC     700000 /* custom voltage */

uint32_t arg_max_oc = 1728000;
uint32_t arg_vdd_uv;
uint32_t arg_optimize = 1;
...
/*Vanilla */
#undef L2
#define L2(x) (&l2_freq_tbl_8960_kraitv2_vanilla[(x)])
static struct l2_level l2_freq_tbl_8960_kraitv2_vanilla[] = {
...
/* ElementalX */
#undef L2
#define L2(x) (&l2_freq_tbl_8960_kraitv2_elementalx[(x)])
static struct l2_level l2_freq_tbl_8960_kraitv2_elementalx[] = {
	[0]  = { {STBY_KHZ, QSB,   0, 0, 0x00 }, 1050000, 1050000, 0 },
	...
	[19] = { { 1458000, HFPLL, 1, 0, 0x36 }, 1150000, 1150000, 7 },
...
/* ultra */
#undef L2
#define L2(x) (&l2_freq_tbl_8960_kraitv2_ultra[(x)])
static struct l2_level l2_freq_tbl_8960_kraitv2_ultra[] = {
	[0]  = { {STBY_KHZ, QSB,   0, 0, 0x00 }, 1050000, 1050000, 0 },
	[1]  = { {  192000, PLL_8, 0, 2, 0x00 }, 1050000, 1050000, 1 },
	[2]  = { {  432000, HFPLL, 2, 0, 0x20 }, 1050000, 1050000, 2 },
	[3]  = { {  486000, HFPLL, 2, 0, 0x24 }, 1050000, 1050000, 2 },
	...
	[13] = { { 1026000, HFPLL, 1, 0, 0x26 }, 1150000, 1150000, 7 },
	[14] = { { 1080000, HFPLL, 1, 0, 0x28 }, 1150000, 1150000, 7 },
	[15] = { { 1134000, HFPLL, 1, 0, 0x2A }, 1150000, 1150000, 8 },
	[16] = { { 1242000, HFPLL, 1, 0, 0x2E }, 1150000, 1150000, 8 },
	[17] = { { 1350000, HFPLL, 1, 0, 0x32 }, 1150000, 1150000, 8 },
	[18] = { { 1458000, HFPLL, 1, 0, 0x36 }, 1150000, 1150000, 8 },
	[19] = { { 1512000, HFPLL, 1, 0, 0x38 }, 1150000, 1150000, 8 },
	[20] = { { 1674000, HFPLL, 1, 0, 0x3E }, 1150000, 1150000, 8 },
	{ }
};

static struct acpu_level acpu_freq_tbl_8960_kraitv2_slower[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),  1000000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),  1000000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),  1000000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),  1000000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),  1000000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),  1000000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),  1000000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),  1150000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(7),  1150000 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(7),  1150000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(7),  1150000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1150000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1150000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(18), 1150000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(18), 1150000 },
	...
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(18), 1200000 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(18), 1200000 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(18), 1225000 },
	{ 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(18), 1250000 },
	{ 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(18), 1250000 },
	{ 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(19), 1275000 },
	{ 1, {  1728000, HFPLL, 1, 0, 0x40 }, L2(19), 1300000 },
	{ 1, {  1782000, HFPLL, 1, 0, 0x42 }, L2(19), 1350000 },
        { 1, {  1836000, HFPLL, 1, 0, 0x44 }, L2(19), 1350000 },
        { 1, {  1890000, HFPLL, 1, 0, 0x46 }, L2(19), 1350000 },
        { 1, {  1944000, HFPLL, 1, 0, 0x48 }, L2(19), 1350000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom1[] = {
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom2[] = {
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom3[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   825000 },
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   825000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   825000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   875000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   900000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   925000 },
...
/* boot arg max_oc */
static int __init cpufreq_read_arg_max_oc(char *max_oc)
{
	unsigned long ui_khz;
	int err;
	err = strict_strtoul(max_oc, 0, &ui_khz);
	if (err) {
		arg_max_oc = 1512000;
		printk(KERN_INFO "[acpuclock]: ERROR using default value!");
		printk(KERN_INFO "[acpuclock]: max_oc='%i'\n", arg_max_oc);
		return 1;
	}
...
__setup("max_oc=", cpufreq_read_arg_max_oc);

/* optimization */
static int __init cpufreq_read_arg_optimize(char *optimize_oc)
{
	unsigned long select_optimize;
	int err;
	err = strict_strtoul(optimize_oc, 0, &select_optimize);
	if (err) {
		arg_optimize = 1;
		printk(KERN_INFO "[acpuclock]: ERROR using default value!");
		printk(KERN_INFO "[acpuclock]: optimize_oc='%i'\n", arg_optimize);
		return 1;
	}

	arg_optimize = select_optimize;
	return 1;
}

__setup("optimize_oc=", cpufreq_read_arg_optimize);


/* boot arg vdd level */
static int __init cpufreq_read_arg_vdd_uv(char *vdd_uv)
{
	unsigned long ui_uv;
	int err;
	err = strict_strtoul(vdd_uv, 0, &ui_uv);
	if (err) {
		arg_vdd_uv = 1;
		printk(KERN_INFO "[acpuclock]: ERROR using default value!");
		printk(KERN_INFO "[acpuclock]: vdd_uv='%i'\n", arg_vdd_uv);
		return 1;
	}
...
__setup("vdd_uv=", cpufreq_read_arg_vdd_uv);



static struct acpu_level *acpu_freq_tbl_8960_v2[NUM_PVS] __initdata = {
	[PVS_SLOWER] = acpu_freq_tbl_8960_kraitv2_slower,
	[PVS_SLOW] = acpu_freq_tbl_8960_kraitv2_slow,
	[PVS_NOM1] = acpu_freq_tbl_8960_kraitv2_nom1,
	[PVS_NOM2] = acpu_freq_tbl_8960_kraitv2_nom2,
	[PVS_NOM3] = acpu_freq_tbl_8960_kraitv2_nom3,
...
/** maxscroff **/
	if ((scroff == true) && (rate > maxscroff_freq))
	    rate = maxscroff_freq;
/** maxscroff end **/
...
static enum pvs __init get_pvs(void)
{
	...
	if (pvs == 0x7)
		...
		if (arg_optimize == 1) {
			...
			pr_info("ElementalX optimization: Vanilla\n");

		} else {
			switch (arg_vdd_uv) {
			case 1:
				pr_info("Extra voltage\n");
				return PVS_SLOWER;
			case 2:
				pr_info("CPU voltage 900-1350\n");
				return PVS_SLOW;
			case 3:
				pr_info("CPU voltage 875-1325\n");
				return PVS_NOM1;
			case 4:
				pr_info("CPU voltage 850-1325\n");
				return PVS_NOM2;
			case 5:
				pr_info("CPU voltage 825-1300\n");
				return PVS_NOM3;
			case 6:
				pr_info("CPU voltage 800-1300\n");
				return PVS_FAST;
			default:
				pr_warn("Unknown. Defaulting to CPU voltage 850-1325.\n");
				return PVS_NOM2;
			}
		}
}
...
static void __init select_freq_plan(void)
{
	...
	if (cpu_is_msm8960()) {
		...
		switch (arg_optimize) {
		   case 1:
			l2_freq_tbl = l2_freq_tbl_8960_kraitv2_vanilla;
			l2_freq_tbl_size = ARRAY_SIZE(l2_freq_tbl_8960_kraitv2_vanilla);
		   case 2:
			l2_freq_tbl = l2_freq_tbl_8960_kraitv2_elementalx;
			l2_freq_tbl_size = ARRAY_SIZE(l2_freq_tbl_8960_kraitv2_elementalx);
		   case 3:
			l2_freq_tbl = l2_freq_tbl_8960_kraitv2_ultra;
			l2_freq_tbl_size = ARRAY_SIZE(l2_freq_tbl_8960_kraitv2_ultra);
		}
	}
	
	BUG_ON(!acpu_freq_tbl);
	if ((krait_needs_vmin()) && (arg_optimize == 1)) {
	...
	/* Adjust frequency table according to boot args max_oc */
	if (arg_max_oc) {
		for (l = acpu_freq_tbl; l->speed.khz != 0; l++) {
			if (l->speed.khz == arg_max_oc) {
